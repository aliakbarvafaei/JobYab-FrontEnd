...
const UpdatePosts: React.FC = () => {
  ...
  const [item, setItem] = useState<null | post>(null);
  ...
  return (
    ...
    >
      <h1 className="text-[20px]">ویرایش آگهی</h1>
        ...
        {activeStep === steps.length ? (
          ...
          <React.Fragment>
            <div style={{ display: activeStep === 0 ? "block" : "none" }}>
              <Step1 handleNext={handleNext} item={item} />
            </div>
            <div style={{ display: activeStep === 1 ? "block" : "none" }}>
              <Step2 handleNext={handleNext} item={item} />
            </div>
            <div style={{ display: activeStep === 2 ? "block" : "none" }}>
              <Step3 handleNext={handleNext} item={item} />
            </div>
            <Box
              style={{
                display: "flex",
