...
const EditAdBox:React.FC = () => {
  ...
  useEffect(()=>{
    ...
    .then((response) => {
      ...
      else if(response.data.image_2===""){
        setPreview([response.data.main_image,response.data.image_1])
      }
      else if(response.data.image_3===""){
        setPreview([response.data.main_image,response.data.image_1,response.data.image_2])
      }
      else {
        setPreview([response.data.main_image,response.data.image_1,response.data.image_2,response.data.image_3])
      }
    })
    .catch((err) => {
    ...
    <>
      <div className={`${themeClass} py-[40px] px-total`}>
        <div className="w-[100%] pt-[10px]">
          <h3 className="text-[24px] font-bold mb-[20px]">ویرایش آگهی</h3>
          <div
            className={`${themeBorder} min-h-[336px] p-[30px] border-[1px] border-solid`}
          >
            {ad===null? <div className="text-center pt-[15px]">
                  <i
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center justify-between">
                        ...
                        <select data-testid="category-select" defaultValue={ad.category} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center justify-between">
                        ...
                        <select data-testid="type-select" defaultValue={ad.type} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center justify-between">
                        ...
                        <select data-testid="status-select" defaultValue={ad.status} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="city-select" defaultValue={ad.province} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="region-select" defaultValue={ad.region} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="neighbor-select" defaultValue={ad.neighbor as string} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="room-select" defaultValue={ad.num_of_beds} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center justify-between">
                        ...
                        <input type='number' min={0} placeholder="سن" defaultValue={ad.age} data-testid="year-select" className={`${themeClass} w-[70%] px-[4%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="elevator-select" defaultValue={ad.elevator? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="parking-select" defaultValue={ad.parking? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="lobby-select" defaultValue={ad.lobby? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="sports_hall-select" defaultValue={ad.sports_hall? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="guard-select" defaultValue={ad.guard? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="swimming_pool-select" defaultValue={ad.swimming_pool? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="balcony-select" defaultValue={ad.balcony? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="roof_garden-select" defaultValue={ad.roof_garden? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] md:w-[45%] mdmin:w-[30%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center  justify-between">
                        ...
                        <select data-testid="remote_door-select" defaultValue={ad.remote_door? "1":"0"} className={`${themeClass} w-[70%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="w-[100%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center">
                        ...
                        <input type="radio" defaultChecked={ad.seller==="شخصی"? true:false} {...register("creator",{
                        ...
                        <div className="flex justify-center items-center gap-[5px]">
                        <input type="radio" defaultChecked={ad.seller==="املاک"? true:false} {...register("creator",{
                            required: "ارائه دهنده اجباری است...",
                ...
                <div className="w-[100%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center">
                        ...
                        <div className="flex justify-center items-center gap-[5px]">
                        <input type="radio" defaultChecked={ad.warehouse===true ? true:false} {...register("warehouse",{
                        ...
                        <div className="flex justify-center items-center gap-[5px]">
                        <input type="radio" defaultChecked={ad.warehouse===false ? true:false} {...register("warehouse",{
                            required: " انباری اجباری است...",
                ...
                <div className="sm:w-[100%] smmin:w-[45%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center">
                        ...
                        <input type='number' min={0} defaultValue={ad.floor_area} placeholder="متر مربع" data-testid="meterage-select" className={`${themeClass} w-[70%] px-[4%] rounded-md border-solid border-[1px] outline-darkGray py-[0.5%] pl-[2%] text-[12px] ${
                ...
                <div className="sm:w-[100%] smmin:w-[45%] text-right flex flex-col gap-[1%] mb-[30px]">
                    <span className="flex flex-row gap-[1%] items-center">
                        ...
                        <input type='number' min={0} defaultValue={ad.total_price} {...priceInput} onChange={(e) => {
                ...
                <div className="mb-[30px] w-[100%] text-right">
                    ...
                    <textarea
                    defaultValue={ad.description as string}
                ...
                <div className="flex lg:flex-col lgmin:flex-row lgmin:justify-between items-center lg:justify-center w-full my-[30px] gap-[30px]">
                    <Map x={ad.location_y} y={ad.location_x} handleLocation={handleLocation}/>
                </div>
